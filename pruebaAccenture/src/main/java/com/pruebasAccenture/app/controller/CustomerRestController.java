...
public class CustomerRestController {
	...
	public ResponseEntity<CustomerEntity> createOrUpdate(@RequestBody CustomerEntity customer) {
		return new ResponseEntity<>(customerService.createOrUpdateCustomer(customer), HttpStatus.OK);
	}

	@RequestMapping(value = "/delete/{id}", method = RequestMethod.DELETE)
	public ResponseEntity<List<CustomerEntity>> delete(@PathVariable("id") Long id) throws RecordNotFoundException {
